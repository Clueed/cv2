...
- [[projects/cv2/cv2|cv2]] — Typst-based CV repo for Mark Vavulov; tailored per application via cv-customizer ( #cv #personal)
...
- [[skills/ai-powered-sales-tooling]] — Mark's three flagship sales automations at Stackgini (ABM data layer, account research, cold email) ( #gtm #automation)
- [[projects/cv2/skills/cv-bullet-style]] — Information-dense, dry, frontloaded — Mark's CV bullet conventions ( #cv #style)
- [[projects/cv2/skills/cv-tailoring-workflow]] — How data.typ is tailored to a JD via the cv-customizer skill ( #cv #workflow)
...
- [[references/tendenz-project]] — tendenz.vercel.app, z-score-based equity-significance tool (2023) ( #cv #side-project)
